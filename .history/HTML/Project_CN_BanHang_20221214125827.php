      ...
      <header id="header">
        <nav class="container">
          ...
          <div class="header_user">
            ...
            $sql = "SELECT * FROM san_pham WHERE  masanpham LIKE'%$noidung%' ";
  
    $result = db_qr($sql);
    $num= db_nums($result);
    $dataProduct = $result ->fetch_object();
    if($num>0)
    {   
        $_SESSION['masanpham']= $dataUser->masanpham;
        $_SESSION['err']="";
        return header("Location: ../HTML/chitietsp.php");
