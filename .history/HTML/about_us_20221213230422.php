    ...
    <div id="main">
      ...
      <div id="content">
        ...
        <div class="content_hello">
          <h2>Welcome to HMK Eyewear</h2>
          <p>
            "HMK Eyewear puts its heart and soul into every product, giving
        ...
        <div class="content_main">
          <p>
            Cửa hàng chuyên cung cấp các loại mắt kính – gọng kính với mức giá
            phù hợp với tâm lý khách hàng và có tính cạnh tranh cao. HMK Eyewear
            luôn luôn mong muốn làm hài lòng tất cả khách hàng.
          </p>
        </div>
        <div class="border"></div>
