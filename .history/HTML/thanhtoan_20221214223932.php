    ...
    <div id="main">
      ...
      <div class="checkout">
        ...
        <div class="form_checkout">
          ...
          <form action="../PHP/donhang_controller.php " method="post" name="frm" id="form" >           
            <div class="info_customer">
              ...
              <p>
                ...
                >
                <span><input type="number" id="phone" name="phone" onfocusout="formValidate()" /></span>
        ...
        $("#formDemo").validate({
          ...
          messages: {
            ...
            username: {
              ...
              username: "Nhập đúng định dạng email đê :D"
            },
