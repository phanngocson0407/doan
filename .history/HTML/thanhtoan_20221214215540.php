...
<html lang="en">
  ...
  <body>
    ...
    <div id="main">
      ...
      <div class="checkout">
        ...
        <div class="form_checkout">
          ...
          <form action="../PHP/donhang_controller.php " method="post" name="frm" onsubmit="return kiemtra()">           
    ...
    <script>
function kiemtra(){
    var u = document.frm.username.value;
    var p = document.frmlogin.p.value;
    if (u=="") { //quy tắc 1
        document.getElementById("baoloi").innerHTML="Chưa nhập username mà";
        return false;
    }
    // if (p=="") {  //quy tắc 2
    //     document.getElementById("baoloi").innerHTML="Chưa nhập password mà";
    //     return false;
    // }
    return true;
}
